...
--beautiful.init("/home/suem/.config/awesome/themes/red/theme.lua")
beautiful.init("/home/suem/.config/awesome/themes/tomorrownightbrighteighties/theme.lua")
--beautiful.init("/home/suem/.config/awesome/themes/nice-and-clean-theme/theme.lua")
...
layouts =
   ...
   globalkeys = awful.util.table.join(
      ...
      awful.util.spawn("dmenu_run -i -l 10 -p 'Run command:' -nb '" ..
      ...
      awful.key({ modkey },            "d",     function ()
                   awful.util.spawn("ruby /home/suem/scripts/windowswitch/autojump.rb 'urxvt -cd ' -i -l 10 -nb '" ..
                                    beautiful.bg_normal .. "' -nf '" .. beautiful.fg_normal ..
                                    "' -sb '" .. beautiful.bg_focus ..
                                    "' -sf '" .. beautiful.fg_focus .. "'")
                                                end),
